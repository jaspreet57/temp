// This is main portable GUI application that take screenshot and paste in word file also by just click on capture button which
// always remain on top of all windows.
    ...
    private void FileSelectorClick(object sender, EventArgs e)
    {
      ...
      protected override void OnFormClosing(FormClosingEventArgs e)
      {
        ...
        public static void Main(String[] args) {
          Console.Title = "JCaptureConsole";
          IntPtr h = FindWindow(null, "JCaptureConsole");
          ShowWindow(h, 0);
